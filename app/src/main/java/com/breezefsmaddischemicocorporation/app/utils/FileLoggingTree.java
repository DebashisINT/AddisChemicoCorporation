...
//                File file = new File(context.getApplicationContext().getFilesDir(), fileName);
                ...
                File file = new File("/data/user/0/com.breezefsmaddischemicocorporation/files", fileName);
                ...
                if(sizeInMb>25){
                        file.delete();
                        file = new File("/data/user/0/com.breezefsmaddischemicocorporation/files", fileName);
                }
